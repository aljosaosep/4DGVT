...
namespace GOT {
    namespace tracking {
        ...
        public:
            ...
            const int detection_category() const;
            ...
            double score() const;
            const std::vector<float>& category_posterior() const;
            ...
            void set_detection_category(int category);
            ...
            void set_category_posterior(const std::vector<float> &post);
        ...
        protected:
            ...
            std::vector<float> category_posterior_;
