...
namespace GOT {
    namespace tracking {
        ...
        public:
            ...
            // Interface
            virtual void InitializeState(const SUN::utils::Camera &camera, const Observation &obs, bool forward,
                                         Hypothesis &hypo) = 0;

            virtual void
            ApplyTransition(const SUN::utils::Camera &camera, const Eigen::VectorXd &u, Hypothesis &hypo) = 0;

            virtual void ApplyCorrection(const SUN::utils::Camera &camera, const Observation &obs, bool forward,
                                         Hypothesis &hypo) = 0;
