...
namespace GOT {
    namespace tracking {
        ...
        /**
           ...
           * The task of this class is to hold the past measurements in a certain temporal window
        ...
        public:
            ...
            /**
               ...
               */
            void AddNewMeasurements(int frame, PointCloudRGBA::ConstPtr reference_cloud,
        ...
        protected:
            /**
                ...
                * @return Boolean, true, if we can get out valid index, or false, if index can not be obatined.
                *         Index usually can not be obtained, if the data, assoc. with query frame number is already
                *         out of the queue (meaning it was 'forgotten').
            */
