        ...
        */
        ...
        public:
            ...
            /**
               ...
               */
            void ComputeDensityMap(pcl::PointCloud<pcl::PointXYZRGBA>::ConstPtr input_cloud,
                                   const SUN::utils::Camera &camera, bool distance_compensate = true,
                                   const double normalization_factor = 1500, const double threshold = 0.2);

            void ComputeHeightMaps(pcl::PointCloud<pcl::PointXYZRGBA>::ConstPtr input_cloud,
            ...
            /**
               ...
               */
            bool GetBinFrom3dPoint(const SUN::utils::Camera &camera, const Eigen::Vector3d &point_3d, int &row,
                                   int &col) const;
