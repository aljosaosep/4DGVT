...
namespace GOT {
    namespace tracking {
        ...
        const int Observation::detection_category() const {
        ...
        void Observation::set_detection_category(int category) {
        ...
        const std::vector<float> &Observation::category_posterior() const {
            return category_posterior_;
        }

        void Observation::set_category_posterior(const std::vector<float> &post) {
            category_posterior_ = post;
        }

        void Observation::set_segm_id(int id) {
            segm_id_ = id;
        }

        int Observation::segm_id() const {
            return segm_id_;
        }
