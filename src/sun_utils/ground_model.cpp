...
namespace SUN {
    namespace utils {
        ...
        Eigen::Vector3d PlanarGroundModel::ProjectPointToGround(const Eigen::Vector3d &p) const {
            ...
            p_proj -= DistanceToGround(p) *
                      Eigen::Vector3d(a, b, c); // Substract plane_normal*dist_to_plane, and we have a projected point!

            return p_proj;
        }

        Eigen::Vector3d PlanarGroundModel::IntersectRayToGround(const Eigen::Vector3d &ray_origin,
        ...
        Eigen::Vector4d
        PlanarGroundModel::FitPlaneToInliersLeastSquares(pcl::PointCloud<pcl::PointXYZRGBA>::Ptr &scene_cloud,
        ...
        void PlanarGroundModel::FitModel(pcl::PointCloud<pcl::PointXYZRGBA>::ConstPtr point_cloud_in,
